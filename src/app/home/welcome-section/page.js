...
import { RiDownloadCloudLine, RiPlayCircleLine } from "react-icons/ri";
...
export default function WelcomeSection() {
  ...
  // Auto switch active card every 10 seconds
  useEffect(() => {
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="max-w-2xl space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="relative bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white px-8 py-4 rounded-xl font-semibold transition-all hover:scale-105 hover:shadow-xl whitespace-nowrap cursor-pointer flex items-center group">
              <RiDownloadCloudLine className="mr-2 text-xl group-hover:translate-y-[-3px] transition-transform" />
              Quick Download Pack
            </button>
            <button className="relative bg-white/10 backdrop-blur-lg hover:bg-white/20 text-white px-8 py-4 rounded-xl font-semibold border border-white/30 transition-all hover:scale-105 whitespace-nowrap cursor-pointer flex items-center group">
