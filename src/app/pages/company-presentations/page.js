  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50">
      <div className="max-w-6xl mx-auto px-6 py-12">
              ...
              >
                <div className="text-center">
                  ...
                  <p className={`font-medium text-sm ${
                    lang.label === "English" ? "text-gray-900" : "text-gray-500"
                  }`}>
                    {lang.label}
                  </p>
                  {lang.label !== "English" && (
        ...
        {/* Main Content - Show presentations only if English is selected */}
        {isEnglishSelected() ? (
          <>
            {/* Presentations Grid */}
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-3">
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-3 rounded-lg hover:shadow-lg transition-all whitespace-nowrap cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                    ...
                    <button
                      ...
                      className="w-full border border-gray-300 text-gray-700 py-3 rounded-lg hover:bg-gray-50 transition-all whitespace-nowrap cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                    >
          ...
          /* Show message when non-English language is selected */
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            <div className="w-20 h-20 bg-gradient-to-r from-purple-100 to-pink-100 rounded-full flex items-center justify-center mx-auto mb-6">
              <RiTranslate2 className="text-purple-600 text-3xl" />
            </div>
            ...
            <button
              onClick={() => handleLanguageClick(0)} // Select English (first language)
              className="inline-flex items-center bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-3 rounded-lg hover:shadow-lg transition-all"
            >
              Switch to English
            </button>
          </div>
