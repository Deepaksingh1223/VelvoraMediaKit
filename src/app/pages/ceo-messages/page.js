    ...
    <>
      ...
      <div className="min-h-screen bg-[#030712] relative overflow-hidden py-12 px-6 pb-20">
        ...
        <div className="relative max-w-[896px] mx-auto">
          ...
          {/* Hero Section */}
          <div className="bg-white/4 border border-white/10 backdrop-blur-[14px] rounded-3xl overflow-hidden mb-8">
            ...
            <div className="p-8">
              <div className="grid md:grid-cols-2 gap-8">
                {/* About Section */}
                <div>
                  <h3 className="text-2xl font-semibold text-white mb-4 tracking-[-0.3px]">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      <div className="w-6 h-6 bg-indigo-500/20 rounded-full flex items-center justify-center mt-1">
                        <RiAwardLine className="text-indigo-400 text-sm" />
                      </div>
                      <div>
                    ...
                    <div className="flex items-start space-x-3">
                      <div className="w-6 h-6 bg-indigo-500/20 rounded-full flex items-center justify-center mt-1">
                        <RiLightbulbLine className="text-indigo-400 text-sm" />
                      </div>
                      <div>
                        <p className="font-medium text-white">
                          AI Innovation
                    ...
                    <div className="flex items-start space-x-3">
                      <div className="w-6 h-6 bg-indigo-500/20 rounded-full flex items-center justify-center mt-1">
                        <RiTeamLine className="text-indigo-400 text-sm" />
                      </div>
                      <div>
                        <p className="font-medium text-white">Future of Work</p>
                        <p className="text-white/60 text-sm">
            ...
            <div className="p-8">
                    ...
                    {currentVideos.length > 0 ? (
                      <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-4">
                        {currentVideos.map((video, index) => (
                          <div
                            key={index}
                            className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:shadow-[0_8px_32px_rgba(99,102,241,0.15)] transition-all duration-300 group h-full flex flex-col min-h-[400px]"
                          >
                            ...
                            <div className="p-6 flex flex-col justify-between h-full">
                              <div>
                                <h3 className="text-lg font-semibold text-white line-clamp-2 leading-tight mb-2">
                                  {video.title}
                                </h3>
                              ...
                              <div className="mt-6">
                                <button
                                  className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white py-3 px-4 rounded-xl hover:shadow-xl transition-all text-sm font-medium whitespace-nowrap cursor-pointer"
                                  onClick={() => handleVideoClick(video)}
                                >
              ...
              {activeTab === "written" && (
                <div className="space-y-6">
                  ...
                  <div className="bg-gradient-to-r from-blue-500/20 to-indigo-500/20 rounded-xl p-8 border border-blue-500/30">
                    <h3 className="text-xl font-semibold text-white mb-4">
